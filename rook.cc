...
bool Rook::valid_move(ChessBoard* bo, Position pos1, Position pos2){
  ...
  if (dist_row == 0 && dist_col > 0 && board[pos2.get_y_pos()][pos2.get_x_pos()] == nullptr) {return true;}
  if (dist_row > 0 && dist_col == 0 && board[pos2.get_y_pos()][pos2.get_x_pos()] == nullptr) {return true;}
  if (dist_row > 0 && dist_col == 0 && board[pos2.get_y_pos()][pos2.get_x_pos()]->get_color() != this->get_color()) {return true;}
  if (dist_row == 0 && dist_col == 0 && board[pos2.get_y_pos()][pos2.get_x_pos()]->get_color() != this->get_color()) {return true;}
  return false;
}

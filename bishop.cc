...
bool Bishop::valid_move(ChessBoard* bo, Position pos1, Position pos2){
  ...
  if (dist_row == dist_col && board[pos2.get_x_pos()][pos2.get_y_pos()] == nullptr) {return true;}
  if (dist_row == dist_col && board[pos2.get_x_pos()][pos2.get_y_pos()]->get_color() != this->get_color()) {return true;}
  return false;
}
